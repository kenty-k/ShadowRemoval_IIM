...
class Options():
    ...
    def init(self, parser):        
        ...
        parser.add_argument('--mask_dir',type=str, default='mask_SASMA', help='mask directory')
        ...
        parser.add_argument('--joint_learning_alpha', type=float, default=0.001, help='joint learning ratio. loss = loss_shadow * joint_learning_alpha + loss_other * (1 - joint_learning_alpha')
